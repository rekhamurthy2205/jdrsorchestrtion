const userService = require('../services/sourceService/user1.service');
...
const findAdminById = async (req, res) => {
  ...
  try {
    ...
    (findOneData.responseObj.responseCode === 200
      ...
      : () => {
        responseMessage = responseStructure.errorResponse('Error in retrieve data');
        res.send(responseMessage);
      })();
  } catch (error) {
    responseMessage = responseStructure.errorResponse('Error Please try again');
    ...
    let responseMessage;
      try {
        ...
        (update.responseObj.responseCode === 200
          ...
          : () => {
            responseMessage = responseStructure.errorResponse('Error in updating data');
            res.send(responseMessage);
          })();
      } catch (error) {
        responseMessage = responseStructure.errorResponse('Error Please try again');
